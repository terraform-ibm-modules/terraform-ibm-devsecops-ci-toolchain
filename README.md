...
2. Rename the **`variables.tfvars.example`** to **`variables.tfvars`**.

3. Provide appropriate values for the variables in the **`variables.tfvars`** to point to various resources within your account.
