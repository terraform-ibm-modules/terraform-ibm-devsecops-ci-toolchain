...
| <a name="input_app_repo_branch"></a> [app\_repo\_branch](#input\_app\_repo\_branch) | Used when app\_from\_url is provided, the default branch that will be used by the CI build, usually either main or master. | `string` | `""` | no |
