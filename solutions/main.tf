module "devsecops_ci_toolchain" {
  ...
  create_custom_repository_default_triggers      = var.create_custom_repository_default_triggers
  ...
  inventory_repo_clone_from_url                  = var.inventory_repo_clone_from_url
  ...
  issues_repo_clone_from_url                     = var.issues_repo_clone_from_url
